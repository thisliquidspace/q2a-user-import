...
/*
	...
	File: qa-plugin/user-import-page/qa-user-import-page.php
	...
	class qa_user_import_page {
		...
		function suggest_requests() // for display in admin interface
		{
			return array(
				array(
					'title' => 'User Import',
					'request' => 'user-import-plugin-page',
		...
		{
			if ($request=='user-import-plugin-page')
				return true;
		...
		function process_request($request)
		{
			...
			$qa_content['title']=qa_lang_html('user_import_page/page_title');
